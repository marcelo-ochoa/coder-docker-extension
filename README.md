...
```bash
$ docker extension install mochoa/coder-docker-extension:4.89.1
Extensions can install binaries, invoke commands and access files on your machine.
Are you sure you want to continue? [y/N] y
Image not available locally, pulling mochoa/coder-docker-extension:4.89.1...
Installing new extension "mochoa/coder-docker-extension:4.89.1"
...
```bash
$ docker extension uninstall mochoa/coder-docker-extension:4.89.1
